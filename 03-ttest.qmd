...
gradethis::grade_this({
  gradethis::pass_if(nrow(.result) == 2 && !anyNA(.result))
  gradethis::fail("Remember to group by the right column, and to remove NA values (na.rm = TRUE) in summary functions.")
})
```
