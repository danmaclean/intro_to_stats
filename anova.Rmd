...
food <- readr::read_csv("data/Interactions_Categorical.csv")
...
marginal = lsmeans(interaction_model, ~ Food:Condiment)
marginal
plot(marginal)
cld(marginal, Letters=letters)
plot(cld(marginal, Letters=letters))

contrast(marginal, adjust="Tukey")
```
...
Why always Tukey - warn what the assumptions are and when they need to look elsewhere
```{r}
