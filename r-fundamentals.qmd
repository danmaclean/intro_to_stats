...
:::{.callout-tip}
## For you to do
Work through the exercises below — the code runs **in your browser**, no installation needed. Type your answer and press *Run*; use *Show solution* if you get stuck. (The original standalone version is still [available online](https://danmaclean.shinyapps.io/r-start).)
:::
